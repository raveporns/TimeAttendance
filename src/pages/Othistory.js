            ...
            <div>
                <div style={styles.formContainer}>
                    <form onSubmit={handleSubmit}>
                        ...
                        <label htmlFor="employeeName" style={styles.label}>ชื่อพนักงาน:</label>
                        <input
                            type="text"
                            id="employeeName"
                            value={employeeName}
                        ...
                        <label htmlFor="startTime" style={styles.label}>วันและเวลาเริ่มต้น:</label>
                        <input
                            type="datetime-local"
                            id="startTime"
                            value={startTime}
                        ...
                        <label htmlFor="endTime" style={styles.label}>วันและเวลาสิ้นสุด:</label>
                        <input
                            type="datetime-local"
                            id="endTime"
                            value={endTime}
                        ...
                        <button type="submit" style={styles.button}>บันทึกการทำงานล่วงเวลา</button>
                    </form>
                </div>
            </div>
        </div>
